    ...
    <div style="overflow: hidden">
        ...
        <div class="ProductBox">
            ...
            <ul>
                ...
                <li class="ListAnim"> Easy to config options that let you tailor the script to your preferences and playstyle</li>
                <li class="ListAnim"> Strong anti-aim that can evade bullets of your enemies</li>
                <li class="ListAnim"> Simple, clean and beautiful visuals that enhance your game experience</li>
