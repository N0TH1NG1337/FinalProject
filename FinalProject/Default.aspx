...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p style="text-align: center"> Digital Dreams is a brand new Lua Script Provider that will enchance your gameplay </p>
    <hr style="border: 1px solid rgba(202, 202, 255, 0.3)"/>

    <h2 style="text-align: center">New Future of Lua Scripts</h2>

    <ul style="list-style-type: none; text-align:center; padding: 0px">
        <li style="display: inline;" class="Tabs"><a runat="server" href="#RageBot">Rage</a></li>
        <li style="display: inline;" class="Tabs"><a runat="server" href="#AntiAim">Anti Aim</a></li>
        <li style="display: inline;" class="Tabs"><a runat="server" href="#Visuals">Visuals</a></li>
        <li style="display: inline;" class="Tabs"><a runat="server" href="#Misc">Misc</a></li>
    </ul>

    <br /><br />

    <div id="RageBot" style="width: 100%; margin: 0 auto; overflow: hidden;">
        <h3> RageBot </h3>
        ...
        <img class="ImageOnHome" style="float: right; margin-left: 10px; width: 40%; max-width: 500px" src="Images/MenuRage.png" />

    </div>

    <br /><br />

    <div id="AntiAim" style="width: 100%; margin: 0 auto; overflow: hidden;">
        ...
        <img class="ImageOnHome" style="float: left; margin-left: 10px; max-width: 500px; width: 40%;" src="Images/MenuAA.png" />

    </div>

    <br /><br />

    <div id="Visuals" style="width: 100%; margin: 0 auto; overflow: hidden;">
        <h3> Visuals </h3>
        ...
        <img class="ImageOnHome" style="float: right; margin-left: 10px; width: 40%; max-width: 500px" src="Images/MenuVisuals.png" />

    </div>

    <br /><br />

    <div id="Misc" style="width: 100%; margin: 0 auto; overflow: hidden;">
        ...
        <img class="ImageOnHome" style="float: left; margin-left: 10px; max-width: 500px; width: 40%;" src="Images/MenuMisc.png" />
